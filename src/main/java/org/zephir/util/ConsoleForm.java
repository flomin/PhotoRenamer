...
public class ConsoleForm {
  ...
  public static final Map<Level, ConsoleLineStyle> levelToStyleMap = new HashMap<>();

  static {
    levelToStyleMap.put(Level.WARN, new ConsoleLineStyle(SWT.BOLD, SWT.COLOR_YELLOW));
    levelToStyleMap.put(Level.ERROR, new ConsoleLineStyle(SWT.BOLD, SWT.COLOR_RED));
    levelToStyleMap.put(Level.FATAL, new ConsoleLineStyle(SWT.BOLD, SWT.COLOR_RED));
  }
  ...
  public ConsoleForm() {
    ...
    if (dis != null) {
      dis.syncExec(this::createSShell);
    }
  }
  ...
  private void createSShell() {
    ...
    sShell.addListener(SWT.Close, event -> {
  ...
  public void println(final List<ConsoleLine> lines) {
    ...
    if (sShell != null && sShell.getDisplay() != null) {
      sShell.getDisplay().asyncExec(() -> {
