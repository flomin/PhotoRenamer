...
//
//            firstImage = new File(destinationFolder, FilenameUtils.getBaseName(file.getName()) + "_1." + FilenameUtils.getExtension(file.getName()));
...
//
//            secondImage = new File(destinationFolder, FilenameUtils.getBaseName(file.getName()) + "_2." + FilenameUtils.getExtension(file.getName()));
    ...
    public static boolean splitImageVertically(final File file, final File destinationFolder) throws CustomException {
        try {
            ...
            if (image.getWidth() > image.getHeight()) {
                ...
                // Working with this plugin: https://github.com/haraldk/TwelveMonkeys#jpeg
