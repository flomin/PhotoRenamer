...
public class SWTLoader {
  ...
  private static final String SWT_VERSION = "3.6.2";
  ...
  private static void loadSWTLibrary() {
    ...
    try {
      ...
      String swtFileNameOsPart = osName.contains("win") ? "win32" : osName.contains("mac") ? "macosx" : osName.contains("linux") || osName.contains("nix") ? "linux_gtk" : null;
